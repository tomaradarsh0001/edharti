            ...
            <div class="row login-box">
                ...
                <div class="col-lg-12 mx-auto form-section" id="formColumnIncrease">
                    <div class="form-inner">
                        ...
                        <form action="<?php echo e(route('publicRegisterCreate')); ?>" method="POST" enctype="multipart/form-data" class="dynamicForm" autocomplete="off">
                            ...
                            <div class="contentDiv" id="propertyownerDiv">
                                ...
                                <div class="row less-padding-input" id="basicDetails">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="mix-field">
                                                        <input type="date" id="dateOfBirth" name="dateOfBirth"
                                                            max="<?php echo e(date('Y-m-d')); ?>" class="form-control" />
                                                        <div class="age-box">
                                                            <h4>Age (in years): </h4>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="mix-field">
                                                        <?php if(!empty($countries) && count($countries) > 0): ?>
                                                            <select name="countryCode" id="countryCode"
                                                                ...
                                                                <?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    <?php if($country->phonecode == 91): ?>
                                                                        <option value="<?php echo e($country->phonecode); ?>"
                                                                            <?php if($country->phonecode == 91): ?> <?php if(true): echo 'selected'; endif; ?> <?php endif; ?>>
                                                                            <?php echo e($country->iso2); ?> (+<?php echo e($country->phonecode); ?>)
                                                                        </option>
                                                                    <?php endif; ?>
                                                        ...
                                                        <div class="form-box relative-input" style="width: 70%;">
                                                            ...
                                                            <img src="<?php echo e(asset('assets/frontend/assets/img/Green-check-mark-icon2.png')); ?>"
                                                                id="green-tick-icon"
                                                                style="
                                                        width: 28px;
                                                        position: absolute;
                                    ...
                                    <div class="col-lg-2">
                                        <div class="preview">
                                            <img id="img-preview" src="<?php echo e(asset('assets/images/image-placeholder.jpg')); ?>"
                                                class="img_prev" />
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="localityInv" id="locality" class="form-select">
                                                        ...
                                                        <?php $__currentLoopData = $colonyList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $colony): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($colony->id); ?>"><?php echo e($colony->name); ?>
                                ...
                                <div class="row --bs-gutter-x-0">
                                    <div class="col-sm-6">
                                        <div class="checkbox form-group d-flex align-items-start gap-3">
                                            ...
                                            <div class="d-flex align-items-center gap-1">
                                                <img src="<?php echo e(route('captcha', ['config' => 'default'])); ?>" alt="captcha" id="orgCaptchaImage"
                                                    class="captcha-image">
                            ...
                            <div class="coming_soonDiv" id="comingsoonDiv" style="display: none;">
                                ...
                                <!-- <img src="<?php echo e(asset('assets/frontend/assets/img/coming-soon2.png')); ?>" alt="Coming Soon" class="coming-soon-img"> -->
                            </div>
                        </form>


                        <div class="clearfix"></div>
                        <p class="mt-2">Already Registered? <a href="<?php echo e(route('login')); ?>">Login here</a></p>
...
<?php $__env->startSection('footerScript'); ?>
 ...
 <script>
        var validateCaptcha = "<?php echo e(route('validateCaptcha')); ?>";
  $('#refreshCaptcha').on('click', function() {
    ...
    <script>
        const otpExpiryTime = `<?php echo e(config('constants.OTP_EXPIRY_TIME') * 60); ?>`;
        ...
        $(document).ready(function() {
            ...
            function handleResendOtp(event, type) {
                ...
                fetch("<?php echo e(route('reSendOtp')); ?>", {
                    method: 'POST',
                    headers: {
...
<?php echo $__env->make('layouts.public.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\wwwroot\edharti\resources\views/auth/public-register.blade.php ENDPATH**/ ?>