...
class DemandController extends Controller
{
    ...
    public function demandLetterPdf($id)
    {
        ...
        $pdf = Pdf::loadView('demand.demand-letter_new', compact('demand', 'name', 'address', 'demandDetails', 'propertyMaster', 'splittedProperty', 'items', 'formulas', 'approvedBy', 'approvedByDesignation'));
