        ...
        <div class="col-lg-12 mb-4">
            <div class="card widget-card">
                <div class="card-body">
                    ...
                    @php
						    $processingTotal = $processingfee->total_amount ?? 0;
					...
					<table class="table table-bordered">
					    ...
					    <tbody>					   
				            <tr>
				                <td id="submitted_service" class="submitted-data"> Application Processing Fee </td>
				                <td  class="submitted-data">
				              <a href="javascript:;" class="app-query-link" data-status="processingfee" data-service="{{$processingfee->status?? ''}}">  ₹ {{ customNumFormat(round($processingfee->total_amount ?? 0, 2)) }}  </a>
				                </td>					               			                
				            </tr>					     
